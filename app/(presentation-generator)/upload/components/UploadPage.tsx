  ...
  return (
    <Wrapper className="pb-10 lg:max-w-[70%] xl:max-w-[65%]">
      ...
      <Button
        ...
        className="w-full rounded-[32px] flex items-center justify-center py-6 bg-primary text-white font-instrument_sans font-semibold text-xl hover:opacity-90 transition-colors duration-300"

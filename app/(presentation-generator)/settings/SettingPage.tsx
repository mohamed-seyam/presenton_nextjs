...
const SettingsPage = () => {
  ...
  return (
    <div className="h-screen bg-background font-instrument_sans flex flex-col overflow-hidden">
      <Header />
          ...
          <button
            ...
            className={`w-full font-semibold py-3 px-4 rounded-lg transition-all duration-500 ${
              buttonState.isDisabled
                ...
                : "bg-primary hover:bg-primary/90 focus:ring-4 focus:ring-primary/30 text-primary-foreground"
            }`}
          >
      ...
      {showDownloadModal && downloadingModel && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-card/95 backdrop-blur-md rounded-xl shadow-2xl max-w-md w-full p-6 relative border border-border">
            {/* Modal Content */}

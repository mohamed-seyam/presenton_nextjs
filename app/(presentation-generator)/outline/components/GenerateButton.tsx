...
const GenerateButton: React.FC<GenerateButtonProps> = ({
  ...
  return (
    <Button
      ...
      className="bg-primary w-full rounded-lg text-base sm:text-lg py-4 sm:py-6 font-instrument_sans font-semibold hover:opacity-90 text-white disabled:opacity-50 disabled:cursor-not-allowed"
    >
      <svg
        className="mr-2"
        width="24"
